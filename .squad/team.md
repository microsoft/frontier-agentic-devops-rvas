...
> frontier-ghplatform-hackathon — "The Frontier GitHub Platform Hackathon"
...
| Kaylee | Frontend / Site Engineer | `.squad/agents/kaylee/charter.md` | ⚛️ Active |
| Zoe | Content / Curriculum Engineer | `.squad/agents/zoe/charter.md` | 🔧 Active |
| Wash | DevOps / Build | `.squad/agents/wash/charter.md` | ⚙️ Active |
| Simon | Tester / QA | `.squad/agents/simon/charter.md` | 🧪 Active |
