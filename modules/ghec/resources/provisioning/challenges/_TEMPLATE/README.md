<!--
  CANONICAL STUDENT-GUIDE TEMPLATE — DO NOT EDIT IN PLACE.
  Copy this file into challenges/ch##-<slug>/README.md and fill every section.
  Every challenge MUST keep these section headings, in this order. The Pages
...
> One-sentence hook: what the student will be able to do by the end.
...
3. **<Task 3 title>** — <…>
4. **<Task 4 title>** — <…>
<!-- Long-form challenge: aim for enough numbered tasks to fill the duration. -->
