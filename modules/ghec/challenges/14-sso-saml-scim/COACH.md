...
- Confirm the applicable identity model and organization SAML/SCIM boundary with objective join, leave, external-identity, enforcement, and rollback evidence.
