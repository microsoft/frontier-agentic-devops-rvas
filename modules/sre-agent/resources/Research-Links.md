...
| [The Practitioner's Mindset](https://danielmeppiel.github.io/agentic-sdlc-handbook/handbook/ch09-the-practitioners-mindset.html) | Source for practitioner habits when working with agents. | Applies directly to Challenge 02 prompt, plan, test, and verify loops. |
| [The Runtime Machine](https://danielmeppiel.github.io/agentic-sdlc-handbook/handbook/ch10-the-runtime-machine.html) | Source for agent runtime concepts. | Useful for Challenge 03 coordination and handoff design. |
| [The Instrumented Codebase](https://danielmeppiel.github.io/agentic-sdlc-handbook/handbook/ch11-the-instrumented-codebase.html) | Source for repo instrumentation as an agent-enablement layer. | Connect to tests, scripts, workflow logs, and validation evidence. |
| [The PROSE Specification](https://danielmeppiel.github.io/agentic-sdlc-handbook/handbook/ch12-the-prose-specification.html) | Source for constraint-based specification practice. | Use as a lens for agent-ready issues and reviewable PRs. |
| [The Load Lifecycle](https://danielmeppiel.github.io/agentic-sdlc-handbook/handbook/ch13-the-load-lifecycle.html) | Source for how context is prepared for agent work. | Connect to concise issue context, relevant files, and acceptance criteria. |
| [Attention and Context Economy](https://danielmeppiel.github.io/agentic-sdlc-handbook/handbook/ch14-attention-and-context-economy.html) | Source for context-budget thinking. | Useful for keeping challenge prompts and handoffs focused. |
| [Deterministic/Probabilistic Boundary](https://danielmeppiel.github.io/agentic-sdlc-handbook/handbook/ch15-deterministic-probabilistic-boundary.html) | Source for separating agent judgment from deterministic validation. | Connect Challenge 04 CI/CD and Challenge 06 investigation evidence. |
| [Multi-Agent Orchestration](https://danielmeppiel.github.io/agentic-sdlc-handbook/handbook/ch16-multi-agent-orchestration.html) | Source for coordinating specialized agents. | Applies to Challenge 03 and Challenge 05 handoff/review loops. |
| [The Execution Meta-Process](https://danielmeppiel.github.io/agentic-sdlc-handbook/handbook/ch17-the-execution-meta-process.html) | Source for iterative execution around agent work. | Useful when coaches explain plan, act, validate, adapt cycles. |
| [Architectural Patterns Rosetta Stone](https://danielmeppiel.github.io/agentic-sdlc-handbook/handbook/ch18-architectural-patterns-rosetta-stone.html) | Source for naming recurring agentic architecture patterns. | Use lightly for coach preparation, not as required student reading. |
| [Anti-Patterns and Failure Modes](https://danielmeppiel.github.io/agentic-sdlc-handbook/handbook/ch19-anti-patterns-and-failure-modes.html) | Source for warning signs in agentic delivery. | Useful for Challenge 05 review and rejection discussion. |
| [Primitives as Code](https://danielmeppiel.github.io/agentic-sdlc-handbook/handbook/ch20-primitives-as-code.html) | Source for making agent primitives inspectable and reusable. | Connect to workflow specs, issue templates, prompts, and runbooks. |
| [The Reference Architecture Earned](https://danielmeppiel.github.io/agentic-sdlc-handbook/handbook/ch21-the-reference-architecture-earned.html) | Source for trust emerging from repeated evidence. | Good closing frame for the full challenge arc. |
...
| [Fault Investigation / CI Doctor](https://github.github.com/gh-aw/blog/2026-01-13-meet-the-workflows-quality-hygiene/) | Source for CI failure and fault-investigation workflow patterns. | Connects Challenge 04 validation failures to Challenge 06 incident investigation. |
...
| [GitHub Copilot What The Hack](https://github.com/microsoft/WhatTheHack/tree/master/071-GitHubCopilot) | Reference for Copilot learning flow. | Useful when shaping Challenge 2. |
