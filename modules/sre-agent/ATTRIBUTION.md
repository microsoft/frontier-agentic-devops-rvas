...
The `resources/` directory is vendored from the source repository's `Resources/` directory.
It contains sample application code, runbooks, infrastructure templates, and reference documentation
supporting the Contoso Claims scenario used throughout this module.
