...
- [ ] Discuss what complex automation you are tempted to build as one giant agent that would be safer split into a producer and a consumer passing state, and where you would put the checkpoint between them. Connect it to a project, task, or workflow you own.
